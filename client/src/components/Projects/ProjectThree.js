                                ...
                                <div id="main">
                                    ...
                                    <div id="hero" class="has-image autoscroll">
                                        <div id="hero-styles">
                                            <div id="hero-caption" class="reverse-parallax-onscroll">
                                                <div class="inner">
                                                    <div class="hero-title"><span>Tag Watch</span></div>
                                    ...
                                    <div id="main-content">
                                        <div id="main-page-content">
                                            ...
                                            <div class="vc_row row_padding_top row_padding_bottom default dark-section" data-bgcolor="#242428">

                                                <div class="two_third">
                                                    <h4 class="has-mask" data-delay="0">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</h4>
                                                    <p class="has-animation" data-delay="400">Lorem Ipsum is simply dummy text of the printing and typesetting industry.o for Lorem Ipsum is simply dummy text of the printing and typesetting industry.sLorem Ipsum is simply dummy text of the printing and typesetting industry..</p>
                                                </div>
                                                ...
                                                <div class="one_third last text-align-right">
                                                    ...
                                                    <div class="button-wrap right disable-drag has-animation" data-delay="350">
                                                        ...
                                                        <a target="_blank" href="https://www.behance.net/gallery/57136617/Time-Tag_Watch"><div class="button-text sticky right"><span data-hover="Read More">Read More</span></div></a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="vc_row full">
                                                ...
                                                <div class="row-half-color first half-dark-section" data-bgcolor="#242428"></div>
                                                ...
                                                <div class="four_fifth">
                                                    <figure class="has-animation has-scale-vertical" data-delay="0">
                                                        <img src="images/projects/tagwatch01.jpg" alt="Image" />
                                                    </figure>
                                                </div>
                                            ...
                                            <div class="vc_row">
                                                ...
                                                <div class="row-half-color second half-dark-section" data-bgcolor="#242428"></div>

                                                <div class="swiper-container content-carousel disable-drag">
                                                    <div class="swiper-wrapper">
                                                        <div class="swiper-slide"><img src="images/projects/tagwatch02.jpg" alt="Image Title" /></div>
                                                        <div class="swiper-slide"><img src="images/projects/tagwatch03.jpg" alt="Image Title" /></div>
                                                        <div class="swiper-slide"><img src="images/projects/tagwatch04.jpg" alt="Image Title" /></div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="vc_row row_padding_top dark-section" data-bgcolor="#242428">

                                                <div class="one_half">
                                                    <p class="has-animation" data-delay="0">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                                            ...
                                            <div class="vc_row dark-section">
                                                ...
                                                <figure class="has-animation has-scale-vertical" data-delay="0">
                                                    <img src="images/projects/tagwatch05.jpg" alt="Image" />
                                                </figure>
                                            ...
                                            <div class="vc_row white-section change-header-color full" data-bgcolor="#fff">

                                                <hr /><hr /><hr />

                                                <div class="content-marquee-wrapper">
                                                    <div class="content-marquee" data-text="We are trusted by over 25,000 clients across the world to power stunning websites.">We are trusted by over 25,000 clients across the world to power stunning websites.</div>
                                                </div>
                                            ...
                                            <div class="vc_row row_padding_top row_padding_bottom dark-section" data-bgcolor="#242428">

                                                <figure class="has-animation has-scale-vertical" data-delay="0">
                                                    <img src="images/projects/tagwatch06.jpg" alt="Image" />
                                                </figure>

                                            </div>


                                            <div class="vc_row full white-section change-header-color full" data-bgcolor="#fff">

                                                <figure class="has-animation has-parallax has-scale" data-delay="100">
                                                    <img src="images/projects/tagwatch07.jpg" alt="Image Title" />
                                                </figure>

                                            </div>


                                            <div class="vc_row small text-align-center row_padding_top row_padding_bottom dark-section" data-bgcolor="#242428">
                                                ...
                                                <div class="next-project-title">
                                                    <div class="inner">
                                                                ...
                                                                <div class="item disable-drag active">
                                                                    <div class="item-appear">
                                                                        <div class="item-content">
                                                                            ...
                                                                            <div class="item-wrap-image"><img src="images/04hero.jpg" class="item-image grid__item-img" data-firstline="Next" data-secondline="Project" alt="" /></div>
                                                                            <img class="grid__item-img grid__item-img--large" src="images/04hero.jpg" />
                                                                        </div>
                                                                        <div class="item-caption">
                                                                            <h2 class="item-title">Dance Room</h2>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="marquee-wrapper">
                                                            <div class="next-title-marquee" data-text="Dance Room Dance Room Dance Room Dance Room Dance Room">Dance Room Dance Room Dance Room Dance Room Dance Room</div>
                                                        </div>
                                                    </div>
                                                </div>
